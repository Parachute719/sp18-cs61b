...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private List<Long> nodesInCurrentWay;
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if (qName.equals("node")) {
            ...
            lastNode = attributes.getValue("ref");
            currentWay.nodes.add(Long.parseLong(lastNode));
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        if (qName.equals("way")) {
            ...
            if (ALLOWED_HIGHWAY_TYPES.contains(currentWay.highway)) {
                for (int i = 0; i < currentWay.nodes.size() - 1; i++) {
                    currentEdge = new GraphDB.Edge(
                            currentWay.nodes.get(i), currentWay.nodes.get(i + 1));
                    g.addEdge(currentEdge);
                }
                g.addAdj(currentWay.nodes);
            }
        }
    }
}
