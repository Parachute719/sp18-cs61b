    ...
    private Node removeHelper(K key, Node p) {
        ...
        if (cmp == 0) {
            switch (deleteCase(p)) {
                ...
                case 2: return p.left;
                case 3: {
                    Node maxNodeInLeft = maxNode(p.left);
                    K maxKeyInLeft = maxNodeInLeft.key;
                    V maxValueInLeft = maxNodeInLeft.value;
                    p.key = maxKeyInLeft;
                    p.value = maxValueInLeft;
                    p.left = removeHelper(maxKeyInLeft, p.left);
                    return p;
                }
                default: return null;
            }
